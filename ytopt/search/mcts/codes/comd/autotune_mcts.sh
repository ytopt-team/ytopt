...
(cd "${SCRIPTPATH}" && python3 "${ROOTPATH}/mctree_mcts_ecp.py" --packing-arrays=r,U,gid,f autotune --outdir="${SAVEPATH}/${BASENAME}_mcts" --polybench-time --exec-args "--nx 72 --ny 64 --nz 64" \
