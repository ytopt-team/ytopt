...
module add openmpi
(cd "${SCRIPTPATH}" && python3 "${ROOTPATH}/mctree_mcts_ecp.py" --packing-arrays=allarray,allwork autotune --outdir="${SAVEPATH}/${BASENAME}_mcts" --polybench-time --exec-args="--nx 94 --ny 94 --nz 94 --max_blocks 128 --uniform_refine 1 --num_refine 2" \
