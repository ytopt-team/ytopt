import pytest
from ytopt.search.nas.baselines.common.tests.envs.fixed_sequence_env import FixedSequenceEnv
...
def test_fixed_sequence(alg, rnn):
    ...
    def env_fn(): return FixedSequenceEnv(n_actions=10, episode_len=5)

    def learn(e): return get_learn_function(alg)(
        env=e,
        network=rnn,
        **kwargs
    )
