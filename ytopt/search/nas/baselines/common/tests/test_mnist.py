...
# from ytopt.search.nas.baselines.acer import acer_simple as acer
from ytopt.search.nas.baselines.common.tests.envs.mnist_env import MnistEnv
from ytopt.search.nas.baselines.common.tests.util import simple_test
from ytopt.search.nas.baselines.run import get_learn_function
...
def test_mnist(alg):
    ...
    def learn_fn(e): return learn(env=e, **learn_kwargs)
    def env_fn(): return MnistEnv(episode_len=100)
