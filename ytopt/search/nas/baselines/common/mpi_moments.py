...
import numpy as np
from ytopt.search.nas.baselines.common import zipsame
...
def test_runningmeanstd():
    ...
    subprocess.check_call(['mpirun', '-np', '3',
                           'python', '-c',
                           'from ytopt.search.nas.baselines.common.mpi_moments import _helper_runningmeanstd; _helper_runningmeanstd()'])
