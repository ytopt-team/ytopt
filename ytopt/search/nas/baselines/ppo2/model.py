...
try:
    from ytopt.search.nas.baselines.common.mpi_adam_optimizer import MpiAdamOptimizer
    from mpi4py import MPI
    from ytopt.search.nas.baselines.common.mpi_util import sync_from_root
except ImportError:
    MPI = None
