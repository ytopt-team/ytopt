...
from ytopt.search.nas.baselines.common.vec_env import VecFrameStack, VecNormalize, VecEnv
from ytopt.search.nas.baselines.common.vec_env.vec_video_recorder import VecVideoRecorder
from ytopt.search.nas.baselines.common.cmd_util import common_arg_parser, parse_unknown_args, make_vec_env, make_env
...
def get_alg_module(alg, submodule=None):
    ...
    try:
        # first try to import the alg module from ytopt.search.nas.baselines
