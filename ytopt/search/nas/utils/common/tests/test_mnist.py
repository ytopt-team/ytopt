...
# from  ytopt.search.nas.utils.acer import acer_simple as acer
from  ytopt.search.nas.utils.common.tests.envs.mnist_env import MnistEnv
from  ytopt.search.nas.utils.common.tests.util import simple_test
from  ytopt.search.nas.utils.run import get_learn_function
...
# by other tests with less compute-hungry nn's and by benchmark
@pytest.mark.skip
@pytest.mark.slow
