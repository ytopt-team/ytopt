...
module add openmpi
(cd "${SCRIPTPATH}" && python3 "${ROOTPATH}/mctree_mcts_ecp_sw4lite_1.py" --packing-arrays=a_mu,a_lambda,a_u,a_lu,a_strx,a_stry,a_strz,a_acof,a_bope,a_ghcof autotune --outdir="${SAVEPATH}/${BASENAME}_mcts" --polybench-time --exec-args "${SCRIPTPATH}/LOH.1-h100.in" --ld-library-path="${CLANG_PREFIX}/lib:${CLANG_PREFIX}/runtimes/runtimes-bins/openmp/runtime/src:/soft/libraries/mpi/openmpi/2.1.6/lib:/home/jkoo/anaconda3/envs/ytune_mc/lib" \
