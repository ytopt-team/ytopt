...
compute_mean_exec_time()
{
    ...
    #$ECHO_CMD "\033[31m[WARNING]\033[0m Variance is above threshold, unsafe performance measurement";
...
export OMP_PROC_BIND=spread #evenly spread the threads around the cores
...
echo "$PROCESSED_TIME" | tee "${CMD}.out"  
