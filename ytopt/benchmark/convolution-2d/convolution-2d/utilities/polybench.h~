...
# define POLYBENCH_ARRAY_CUDA(var2) var2

//2d array
# define POLYBENCH_2D_ARRAY_DECL_CUDA(var2,type,ANI,ANJ,ni,nj) type *var2=NULL; cudaSafeCall(cudaMallocManaged((void **) &var2, (ANI)*(ANJ)*(sizeof(type)),1));
# define POLYBENCH_2D_CUDA(var2, dim1, dim2, ddim1, ddim2) *var2
# define POLYBENCH_2D_REF(var2, dim1, dim2, i, j) var2[(i)*(dim1)+(j)]

//make one for 1d array
# define POLYBENCH_1D_ARRAY_DECL_CUDA(var1,type,ANI,ni) type *var1=NULL; cudaSafeCall(cudaMallocManaged((void **) &var1, (ANI)*(sizeof(type)),1));
# define POLYBENCH_1D_CUDA(var1, dim1, ddim1) *var1
# define POLYBENCH_1D_REF(var1, dim1, i) var1[i]

//make one for 3d array
//# define POLYBENCH_3D_ARRAY_DECL_CUDA(var,type,ANI,ANJ,ANK,ni,nj,nk) type *var=NULL;
//cudaSafeCall(cudaMallocManaged((void **) &var, (ANI)*(ANJ)*(ANK)(sizeof(type)),1));
