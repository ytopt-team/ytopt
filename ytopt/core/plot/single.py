"""ytopt analytics - single study documentation

usage:

::

    $ ytopt-analytics parse ppo_test/ppo_test_382DS/ytopt.log
    $ ytopt-analytics single ppo_test_2019-05-07_14.json
...
def add_subparser(subparsers):
    ...
    parser_parse.add_argument(
        'path', type=str, help=f'A Json file generated by "ytopt-analytics parse".')
