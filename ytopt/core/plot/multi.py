"""ytopt analytics - multi study documentation

usage:

::

    $ ytopt-analytics parse ppo_test1/ppo_test_382DS/ytopt.log
    $ ytopt-analytics parse ppo_test2/ppo_test_23HDS/ytopt.log
    $ ytopt-analytics multi ppo_test1_2019-05-07_14.json ppo_test1_2019-05-07_14.json

"""

import os
import argparse
from ytopt.core.plot.jn_loader import NbEdit
...
def add_subparser(subparsers):
    ...
    parser_parse = subparsers.add_parser(
        subparser_name, help='Tool to generate analytics from multiple NAS experiment (jupyter notebook).')
    parser_parse.add_argument(
        'path',
        type=str,
        nargs='+',
        help=f'Json files generated by "ytopt-analytics parse".')
