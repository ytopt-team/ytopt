...
#omp target schedule
p7= CSH.CategoricalHyperparameter(name='p7', choices=["schedule(static,1)","schedule(static,2)","schedule(static,4)","schedule(static,8)","schedule(static,16)","schedule(static,32)", " "], default_value=' ')
#OMP_TARGET_OFFLOAD
