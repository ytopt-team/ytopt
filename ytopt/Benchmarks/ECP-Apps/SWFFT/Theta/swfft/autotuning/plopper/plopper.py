...
class Plopper:
    ...
    def findRuntime(self, x, params):
        ...
        cmd1 =  "CC -O3 -fopenmp -Wall -dynamic -DDFFT_TIMING=0 -I/opt/cray/pe/fftw/3.3.8.6/mic_knl/include " \
                + " -I" +kernel_dir + " -c -o " + tmpbinary + ".o " + interimfile \
                + " ;  cc -O3 -std=gnu99 -fopenmp -Wall -dynamic -Wno-deprecated -DDFFT_TIMING=0 -I/opt/cray/pe/fftw/3.3.8.6/mic_knl/include " \
                + " -I" +kernel_dir +" -c -o " +kernel_dir + "/distribution.o " + kernel_dir + "/distribution.c " \
                + " ; CC -O3 -fopenmp -Wall -dynamic "  \
