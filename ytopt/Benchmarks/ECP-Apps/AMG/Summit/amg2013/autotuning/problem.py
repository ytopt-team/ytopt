...
# number of threads (x4)
p0= CSH.OrdinalHyperparameter(name='p0', sequence=['1','2','4','5','8','10','16','21','32','42'], default_value='42')
# omp placement
p1= CSH.CategoricalHyperparameter(name='p1', choices=['cores','threads','sockets'], default_value='cores')
# unrolling 3
p2= CSH.CategoricalHyperparameter(name='p2', choices=["#pragma unroll(3)", "#pragma unroll"," "], default_value=' ')
#omp parallel
p3= CSH.CategoricalHyperparameter(name='p3', choices=["#pragma omp parallel for", " "], default_value=' ')
# unrolling 6
p4= CSH.CategoricalHyperparameter(name='p4', choices=["#pragma unroll(6)", "#pragma unroll", " "], default_value=' ')
# OMP_PROC_BIND
p5= CSH.CategoricalHyperparameter(name='p5', choices=['close','spread','master'], default_value='close')
# OMP_SCHEDULE
p6= CSH.CategoricalHyperparameter(name='p6', choices=['dynamic','static'], default_value='static')
