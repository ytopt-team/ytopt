...
#P7
#P2
#pragma clang loop(i3,j3,k3) tile sizes(#P3,#P4,#P5) floor_ids(i1,j1,k1) tile_ids(i2,j2,k2)
...
#P9
#P2
#pragma clang loop(i4,j4,k4) tile sizes(#P3,#P4,#P5) floor_ids(i1,j1,k1) tile_ids(i2,j2,k2)
