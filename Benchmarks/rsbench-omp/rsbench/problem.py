...
p2= CSH.OrdinalHyperparameter(name='p2', sequence=['10','20','40','64','80','100','128','160','200'], default_value='100')
#omp parallel
p3= CSH.CategoricalHyperparameter(name='p3', choices=["#pragma omp parallel for", " "], default_value=' ')
#thread affinity type
p4= CSH.CategoricalHyperparameter(name='p4', choices=['compact','scatter','balanced','none','disabled', 'explicit'], default_value='none')
# omp placement
p5= CSH.CategoricalHyperparameter(name='p5', choices=['cores','threads','sockets'], default_value='cores')
