This directory includes all files for autotuning ECP app HeFFTe (https://github.com/icl-utk-edu/heffte) using ytopt-libensemble on a laptop, ALCF Theta and OLCF Crusher.
