...
# arg8
p7 = CSH.CategoricalHyperparameter(name='p7', choices=["-ingrid 4 4 4", "-ingrid 8 4 2", "-ingrid 4 8 2","-ingrid 2 4 8", "-ingrid 16 2 2", "-ingrid 32 2 1", "-ingrid 64 1 1", " "], default_value=" ")
# arg9
p8 = CSH.CategoricalHyperparameter(name='p8', choices=["-outgrid 4 4 4", "-outgrid 8 4 2", "-outgrid 4 8 2","-outgrid 2 4 8","-outgrid 16 2 2", "-outgrid 32 2 1", "-outgrid 64 1 1"," "], default_value=" ")
#number of threads
