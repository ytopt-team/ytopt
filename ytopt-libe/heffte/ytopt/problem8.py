...
# arg8
p7 = CSH.CategoricalHyperparameter(name='p7', choices=["-ingrid 4 2 1", "-ingrid 2 2 2", "-ingrid 4 1 2","-ingrid 1 4 2", "-ingrid 1 2 4"," "], default_value=" ")
# arg9
p8 = CSH.CategoricalHyperparameter(name='p8', choices=["-outgrid 4 2 1", "-outgrid 2 2 2", "-outgrid 4 1 2","-outgrid 1 4 2","-outgrid 1 2 4"," "], default_value=" ")
#number of threads
