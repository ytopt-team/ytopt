...
libE_specs['sim_dir_symlink_files'] = [here + f for f in ['julia.sh', 'scripts', 'src', 'exe.pl', 'plopper.py', 'processexe.pl']]
...
# optimizer
p2 = Categorical("p2", ["rmsprop", "adam"], default="rmsprop")
...
gen_specs = {
    ...
    'out': [('p0', float, (1,)), ('p1', int, (1,)), ('p2', "<U24", (1,)), ],
