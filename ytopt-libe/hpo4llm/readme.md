Hyperparameter Optimization for LLM training loss benchmark for different scaling laws using ytopt-libe

This benchmark is for the different llm scaling laws' loss benchmark in ytopt and the HPO/libE benchmarks. It is designed to be used with libEnsemble for hyperparameter optimization of an LLM loss function for a given scaling law. See its details in the paper (https://arxiv.org/pdf/2508.06617).
