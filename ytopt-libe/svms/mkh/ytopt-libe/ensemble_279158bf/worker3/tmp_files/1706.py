...
class Classification:
    ...
    def run(self) -> NDArray[np.float64]:
        ...
        mixing_ratio = 0.19160000000000002
        sigmoid_ratio = 0.00022917204246570652
        gaussian_ratio = 0.9108538773036612
        coef0_param = 0.40000000000000013
        C_param = 6.640000000000001
